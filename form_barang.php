                ...
                <div class="row d-flex justify-content-center">
                    <div class="col col-8 p-4 bg-light">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input id="Id_barang" class="form-control" type="text" placeholder="iD barang" required name="Id_barang"/>
                        </div>

                <div class="form-group mb-2">
                    <label for="nama_barang">Nama Barang</label>
                    <input id="nama_barang" class="form-control" type="text" placeholder="Nama Barang " required name="nama_barang"/>
                </div>
